  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">{question.question}</h2>
        {question.type === 'multiple-choice' && question.maxSelections && (
          <p className="text-base text-gray-500">Select up to {question.maxSelections} options</p>
        )}
      </div>
